            ...
            <section className="space-y-12">
              <div className="space-y-8">
                <div className="p-8 bg-secondary rounded-lg">
                  <h3 className="text-2xl font-bold text-foreground mb-4">NYU - Circular Economy</h3>
                ...
                <div className="p-8 bg-secondary rounded-lg">
                  <h3 className="text-2xl font-bold text-foreground mb-4">NYU - (Physical) Product Design and Development</h3>
                  <p className="text-foreground leading-relaxed">
                ...
                <div className="p-8 bg-secondary rounded-lg">
                  <h3 className="text-2xl font-bold text-foreground mb-4">Pioneer Works - Design and Modeling</h3>
                  <p className="text-foreground leading-relaxed">
